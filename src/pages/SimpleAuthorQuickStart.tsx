...
export function SimpleAuthorQuickStart() {
  return (
    <QuickStartGuide
      ...
      resources={{
        heading: "Keep learning with Simple Author",
        description:
          "Explore the official overview and access instructions, try the guest demo, or continue with the self paced training modules.",
        links: [
          {
